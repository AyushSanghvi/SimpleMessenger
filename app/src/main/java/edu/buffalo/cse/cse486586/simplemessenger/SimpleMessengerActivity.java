...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            String clientRecievedString = null;
            Socket connectionSocket = null;
            BufferedReader msgRecieved = null;

            try {
            connectionSocket = serverSocket.accept();
            assert connectionSocket != null;
            msgRecieved = new BufferedReader(new InputStreamReader(connectionSocket.getInputStream()));

            while ((clientRecievedString = msgRecieved.readLine()) != null) {
                  publishProgress(clientRecievedString);
            }
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                 ...
                 */
                PrintWriter msgToServer = new PrintWriter(new OutputStreamWriter(socket.getOutputStream()));
